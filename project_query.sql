...
-- Written all the track names that have a song length longer than the average song length. 
-- Written the name and Milliseconds for each track. Order by the song length with the longest
-- songs listed first.alter
